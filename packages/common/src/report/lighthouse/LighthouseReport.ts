...
import { logger, type ValidatedAnalysisInput } from "../../index.ts";
import type { Service } from "../../service/Service.ts";
import type { GenericReport, ReportArguments } from "../Report.ts";
import type { LighthouseResult } from "./LighthouseResult.ts";
...
export class LighthouseReport implements GenericReport<LighthouseResult> {
  ...
  constructor(
    { analyzedUrl, date, result, resultUrl, service, inputs }: ReportArguments<
      LighthouseResult
    >,
  ) {
